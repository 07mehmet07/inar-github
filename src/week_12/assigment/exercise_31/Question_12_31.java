package week_12.assigment.exercise_31;
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 2010; i >= 2001; i--) {
                File file = new File("C:\\Users\\Dell\\IdeaProjects\\inar-github\\src\\week_12\\assigment\\exercise_30\\babyNames\\babynameranking" + i + ".txt");
