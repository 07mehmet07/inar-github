package week_12.assigment.exercise_28;
...
//        File directory = new File("C:\\Users\\Dell\\IdeaProjects\\inar-github\\src\\week_12\\assigment\\exercise_28\\directory");
//        directory.mkdir();
//        for (int i = 1; i <= 2; i++) {
//            for (int j = 1; j <= 15; j++) {
//                PrintWriter file =
//                        new PrintWriter("C:\\Users\\Dell\\IdeaProjects\\inar-github\\src\\week_12\\assigment\\exercise_28\\directory\\Question" + i +
//                                "_" + j);
//
//            }
//        }
